...
import { orangeJuiceImg } from '../../../../public/assets';
        ...
        <div className='flex flex-col lg:flex-row items-center'>
          ...
          <div className='flex flex-col justify-center ml-0 lg:ml-[9rem]'>
            ...
            <p className='text-[#555555] tracking-wider text-sm'>
              A timeless classic that delights the senses, this orange juice is a
              <br /> vibrant blend of taste and nutrition. Rich in vitamin C, it provides a
              <br /> powerful boost to your immune system, helping to keep you healthy
              <br /> and energetic. Each sip is a burst of refreshing, tangy-sweet flavor,
              <br /> offering a perfectly balanced taste that captures the essence of
              <br /> freshly squeezed oranges. The juice is carefully crafted to preserve
              <br /> the natural goodness of the fruit, ensuring a high-quality, wholesome
              <br /> beverage. Its zesty and invigorating profile makes it an ideal choice for
              <br /> starting your day or enjoying as a revitalizing treat at any time.
              <br /> Whether served chilled or at room temperature, this orange juice
              <br /> delivers a delicious and refreshing experience with every glass.
            </p>
