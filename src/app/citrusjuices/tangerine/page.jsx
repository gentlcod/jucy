...
import { tangerineJuiceImg } from '../../../../public/assets';
        ...
        <div className='flex flex-col lg:flex-row items-center'>
          ...
          <div className='flex flex-col justify-center ml-0 lg:ml-[9rem]'>
            ...
            <p className='text-[#555555] tracking-wider text-sm'>
              A sweet and refreshing delight, this tangerine juice is a vibrant blend of juicy,<br />
              citrusy flavors. Rich in vitamin C, it provides a natural boost to your immune system<br />
              and revitalizes your energy levels. Each sip is a burst of tangy-sweet goodness,<br />
              capturing the essence of freshly squeezed tangerines. Carefully crafted to preserve<br />
              the natural brightness of the fruit, this juice ensures a high-quality, wholesome beverage.<br />
              Its sweet and invigorating profile makes it an excellent choice for a refreshing start<br />
              to your day or enjoying as a revitalizing treat at any time. Whether enjoyed chilled or<br />
              at room temperature, this tangerine juice offers a delicious and uplifting experience<br />
              with every glass.
            </p>
