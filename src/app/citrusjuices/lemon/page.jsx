...
import { lemonJuiceImg } from '../../../../public/assets';
...
const Lemon = () => {
  ...
  Bright and zesty, this lemon juice offers a refreshing burst of citrus flavor that<br />
  awakens the senses. Packed with vitamin C, it provides a natural boost to your<br />
  immune system and revitalizes your energy levels. Each sip delivers a tangy punch,<br />
  capturing the essence of freshly squeezed lemons. Crafted to maintain the vibrant<br />
  and zesty profile of the fruit, this juice ensures a high-quality, wholesome beverage.<br />
  Its lively and tart flavor makes it an excellent choice for adding a splash of<br />
  refreshment to your day or enjoying as a revitalizing treat at any time. Whether enjoyed<br />
  chilled or at room temperature, this lemon juice delivers a delicious and invigorating<br />
