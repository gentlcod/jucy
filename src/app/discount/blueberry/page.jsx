...
import { blueBerryJuiceImg } from '../../../../public/assets';
...
const BlueberryDiscount = () => {
  ...
  A vibrant and nourishing delight, this blueberry juice offers a<br />
  delightful burst of flavor. Rich in antioxidants and vitamins,<br />
  it provides a natural boost to your immune system,<br />
  supporting overall health and vitality. Each sip delivers a<br />
  harmonious blend of sweet and slightly tangy notes,<br />
  perfectly capturing the essence of freshly squeezed blueberries.<br />
  Crafted to preserve the fruit's natural richness, this juice ensures<br />
  a high-quality, wholesome beverage. Its rich and fruity profile<br />
  makes it an excellent choice for a revitalizing start to your day<br />
  or a refreshing treat at any time. Whether enjoyed chilled or<br />
  at room temperature, this blueberry juice delivers a delicious<br />
  and invigorating experience with every glass.
</p>
...
export default BlueberryDiscount;
