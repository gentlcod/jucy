...
import { passionFruitJuiceImg } from '../../../../public/assets';
...
const PassionFruitDiscount = () => {
  ...
  A tangy and exotic treat, this passion fruit juice offers a<br />
  burst of vibrant and tropical flavor. Rich in antioxidants and<br />
  vitamin C, it supports your immune system and promotes overall<br />
  wellness. Each sip delivers a refreshing taste of freshly squeezed<br />
  passion fruits, capturing their unique tanginess and aromatic profile.<br />
  Carefully crafted to maintain the fruit's natural brightness, this juice<br />
  ensures a high-quality, wholesome beverage. Its bold and tangy profile<br />
  makes it an excellent choice for a revitalizing start to your day or a<br />
  refreshing treat at any time. Whether enjoyed chilled or at room<br />
  temperature, this passion fruit juice delivers a delicious and rejuvenating<br />
  experience with every glass.
</p>
...
export default PassionFruitDiscount;
