...
import { lycheeJuiceImg } from '../../../../public/assets';
...
const LycheeDiscount = () => {
  ...
  A sweet and fragrant treat, this lychee juice offers a burst of<br />
  delicate floral and fruity flavor. Rich in antioxidants and vitamin C,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly squeezed lychees, capturing their<br />
  unique sweetness and aromatic profile. Carefully crafted to maintain<br />
  the fruit's natural brightness, this juice ensures a high-quality,<br />
  wholesome beverage. Its sweet and fragrant profile makes it an<br />
  excellent choice for a revitalizing start to your day or a refreshing<br />
  treat at any time. Whether enjoyed chilled or at room temperature,<br />
  this lychee juice delivers a delicious and rejuvenating experience<br />
  with every glass.
</p>
