...
import { honeyDewJuiceImg } from '../../../../public/assets';
...
const HoneydewDiscount = () => {
  ...
  A smooth and refreshing delight, this honeydew juice offers a<br />
  burst of sweet and mellow flavor. Rich in vitamins A and C, it supports<br />
  your immune system and promotes overall wellness. Each sip delivers<br />
  a taste of freshly squeezed honeydews, capturing their natural sweetness<br />
  and smooth texture. Carefully crafted to maintain the fruit's vibrant essence,<br />
  this juice ensures a high-quality, wholesome beverage. Its smooth and sweet<br />
  profile makes it an excellent choice for a revitalizing start to your day or a<br />
  refreshing treat at any time. Whether enjoyed chilled or at room temperature,<br />
  this honeydew juice delivers a delicious and rejuvenating experience with<br />
  every glass.
</p>
...
export default HoneydewDiscount;
