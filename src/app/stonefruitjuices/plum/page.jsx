...
import { honeyDewJuiceImg, plumJuiceImg } from '../../../../public/assets';
...
const Plum = () => {
  ...
  A tangy and sweet delight, this plum juice offers a burst of<br />
  juicy and rich flavor. Packed with antioxidants and vitamins A and C,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly squeezed plums, capturing their<br />
  natural sweetness and slightly tart profile. Carefully crafted to maintain<br />
  the fruit's natural brightness, this juice ensures a high-quality,<br />
  wholesome beverage. Its tangy and sweet profile makes it an excellent<br />
  choice for a revitalizing start to your day or a refreshing treat at<br />
  any time. Whether enjoyed chilled or at room temperature, this plum<br />
  juice delivers a delicious and rejuvenating experience with every glass.
</p>
