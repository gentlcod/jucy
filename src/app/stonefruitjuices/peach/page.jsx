...
import { cantalopeJuiceImg, peachJuiceImg } from '../../../../public/assets';
...
const Peach = () => {
  ...
  A sweet and fragrant treat, this peach juice offers a burst of<br />
  juicy and fruity flavor. Rich in vitamins A and C, it supports<br />
  your immune system and promotes overall wellness. Each sip delivers<br />
  a taste of freshly squeezed peaches, capturing their natural sweetness<br />
  and aromatic profile. Carefully crafted to preserve the fruit's vibrant<br />
  essence, this juice ensures a high-quality, wholesome beverage. Its<br />
  sweet and fragrant profile makes it an excellent choice for a revitalizing<br />
  start to your day or a refreshing treat at any time. Whether enjoyed chilled<br />
  or at room temperature, this peach juice delivers a delicious and rejuvenating<br />
