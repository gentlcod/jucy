...
import { apricotJuiceImg, cantalopeJuiceImg, peachJuiceImg } from '../../../../public/assets';
...
const Apricot = () => {
  ...
  A sweet and delicate treat, this apricot juice offers a<br />
  burst of fruity and mellow flavor. Rich in vitamins A and C,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly squeezed apricots, capturing<br />
  their natural sweetness and smooth texture. Carefully crafted to<br />
  preserve the fruit's vibrant essence, this juice ensures a high-quality,<br />
  wholesome beverage. Its sweet and delicate profile makes it an<br />
  ...
  this apricot juice delivers a delicious and rejuvenating experience<br />
  with every glass.
</p>
