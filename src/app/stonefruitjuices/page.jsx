  ...
  const items = [
    {
      name: 'Peach',
      price: 11.00,
      imageUrl: peachJuiceImg,
      description: 'Sweet and fragrant, bursting with the flavor of ripe peaches.',
    },
    {
      name: 'Plum',
      originalPrice: 10.00,
      price: 8.00,
      hasDiscount: true,
      imageUrl: plumJuiceImg,
      description: 'Bright and zesty, perfect for adding a refreshing tartness to any drink or dish.',
    },
    {
      name: 'Apricot',
      price: 9.00,
      imageUrl: apricotJuiceImg,
      description: 'Rich and flavorful, a perfect blend of sweet and tart.',
    },
  ];
  ...
  return (
    <>
      ...
      <div className="pt-[121px] lg:pb-1 pb-42 overflow-hidden lg:px-[120px] px-5" data-aos="fade-down" data-aos-duration="1500">
        <h5 className='pb-6 font-medium text-[#53422B] text-2xl'>Stone Fruit Juices</h5>
