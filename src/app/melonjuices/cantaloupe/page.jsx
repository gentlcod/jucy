...
import { cantalopeJuiceImg } from '../../../../public/assets';
...
const Cantalope = () => {
  ...
  A sweet and refreshing treat, this cantaloupe juice offers a<br />
  burst of juicy and tropical flavor. Rich in vitamins A and C,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly squeezed cantaloupes, capturing<br />
  their natural sweetness and aromatic profile. Carefully crafted to<br />
  preserve the fruit's vibrant essence, this juice ensures a high-quality,<br />
  wholesome beverage. Its sweet and tropical profile makes it an excellent<br />
  choice for a revitalizing start to your day or a refreshing treat at<br />
  any time. Whether enjoyed chilled or at room temperature, this cantaloupe<br />
