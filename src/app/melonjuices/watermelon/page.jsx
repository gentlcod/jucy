...
import { waterMelonJuiceImg } from '../../../../public/assets';
...
const Watermelon = () => {
  ...
  A juicy and refreshing delight, this watermelon juice offers a<br />
  burst of sweet and hydrating flavor. Rich in vitamins A and C,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly squeezed watermelons, capturing<br />
  their natural sweetness and hydrating qualities. Carefully crafted to<br />
  preserve the fruit's natural vibrancy, this juice ensures a high-quality,<br />
  wholesome beverage. Its sweet and hydrating profile makes it an excellent<br />
  choice for a revitalizing start to your day or a refreshing treat at<br />
  any time. Whether enjoyed chilled or at room temperature, this watermelon<br />
