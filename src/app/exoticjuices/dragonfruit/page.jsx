...
import { dragonFruitJuiceImg } from '../../../../public/assets';
...
const dragonFruit = () => {
  ...
  A vibrant and refreshing delight, this dragon fruit juice offers a<br />
  unique burst of mildly sweet and exotic flavor. Rich in antioxidants<br />
  and vitamin C, it supports your immune system and promotes overall<br />
  wellness. Each sip delivers a taste of freshly squeezed dragon fruits,<br />
  capturing their delicate sweetness and striking appearance. Carefully<br />
  crafted to maintain the fruit's natural vibrancy, this juice ensures a<br />
  high-quality, wholesome beverage. Its distinctive and refreshing profile<br />
  ...
  temperature, this dragon fruit juice delivers a delicious and rejuvenating<br />
