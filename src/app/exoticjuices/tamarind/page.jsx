...
import { tamaringJuiceImg } from '../../../../public/assets';
...
const Tamarind = () => {
  ...
  A tangy and exotic delight, this tamarind juice offers a burst of<br />
  rich and tangy flavor. Rich in antioxidants and essential nutrients,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly extracted tamarind, capturing<br />
  its unique tanginess and complex flavor profile. Carefully crafted<br />
  to preserve the fruit's natural brightness, this juice ensures a<br />
  high-quality, wholesome beverage. Its bold and tangy profile makes<br />
  it an excellent choice for a revitalizing start to your day or a<br />
  refreshing treat at any time. Whether enjoyed chilled or at room<br />
  temperature, this tamarind juice delivers a delicious and rejuvenating<br />
