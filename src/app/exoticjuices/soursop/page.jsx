...
import { sourSopJuiceImg } from '../../../../public/assets';
...
const Soursop = () => {
  ...
  A tropical and creamy delight, this soursop juice offers a<br />
  refreshing burst of sweet and tangy flavor. Rich in antioxidants<br />
  and vitamin C, it supports your immune system and promotes overall<br />
  wellness. Each sip delivers a taste of freshly squeezed soursops,<br />
  capturing their unique creamy texture and tropical sweetness.<br />
  Carefully crafted to maintain the fruit's natural vibrancy, this juice<br />
  ...
  temperature, this soursop juice delivers a delicious and rejuvenating<br />
