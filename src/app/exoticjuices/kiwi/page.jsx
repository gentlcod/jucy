...
import { kiwiJuiceImg } from '../../../../public/assets';
...
const Kiwi = () => {
  ...
  A tangy and refreshing treat, this kiwi juice offers a burst of<br />
  vibrant and fruity flavor. Rich in vitamin C and antioxidants,<br />
  it supports your immune system and promotes overall wellness.<br />
  Each sip delivers a taste of freshly squeezed kiwis, capturing their<br />
  unique tanginess and vibrant green color. Carefully crafted to maintain<br />
  the fruit's natural brightness, this juice ensures a high-quality,<br />
  wholesome beverage. Its lively and tangy profile makes it an excellent<br />
  choice for a revitalizing start to your day or a refreshing treat at<br />
  any time. Whether enjoyed chilled or at room temperature, this kiwi<br />
