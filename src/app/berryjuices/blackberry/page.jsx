...
import { blackBerryJuceImg } from '../../../../public/assets';
...
const Blackberry = () => {
  ...
  A rich and tantalizing treat, this blackberry juice offers a<br />
  delightful burst of deep, fruity flavor. Packed with antioxidants and<br />
  essential nutrients, it provides a natural boost to your immune system,<br />
  supporting overall wellness and vitality. Each sip delivers a<br />
  harmonious blend of sweet and slightly tart notes,<br />
  perfectly capturing the essence of freshly squeezed blackberries.<br />
  Carefully crafted to preserve the fruit's natural richness, this juice ensures<br />
  a high-quality, wholesome beverage. Its bold and complex profile<br />
  ...
  at room temperature, this blackberry juice delivers a delicious<br />
  and rejuvenating experience with every glass.
</p>
