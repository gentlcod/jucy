...
import { strawBerryImg } from '../../../../public/assets';
...
const Strawberry = () => {
  ...
  A sweet and delightful treat, this strawberry juice offers a<br />
  burst of juicy flavor and natural sweetness. Rich in antioxidants<br />
  and vitamin C, it provides a refreshing boost to your immune system,<br />
  supporting overall wellness. Each sip delivers a harmonious blend of<br />
  sweet and slightly tangy notes, perfectly capturing the essence<br />
  of freshly squeezed strawberries. Carefully crafted to preserve<br />
  the fruit's natural brightness, this juice ensures a high-quality,<br />
  wholesome beverage. Its vibrant and pleasant profile makes it an<br />
  ...
  this strawberry juice delivers a delicious and rejuvenating experience<br />
  with every glass.
</p>
