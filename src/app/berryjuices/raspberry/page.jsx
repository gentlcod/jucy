...
import { raspBerryImg } from '../../../../public/assets';
...
const Raspberry = () => {
  ...
  A vibrant and flavorful treat, this raspberry juice offers a<br />
  delightful burst of fruity sweetness and tang. Packed with antioxidants<br />
  and essential nutrients, it supports overall wellness and boosts your<br />
  immune system. Each sip delivers a burst of fresh raspberry flavor,<br />
  perfectly balancing sweet and slightly tart notes. Carefully crafted<br />
  to preserve the fruit's natural vibrancy, this juice ensures a high-quality,<br />
  wholesome beverage. Its lively and refreshing profile makes it an<br />
  ...
  this raspberry juice delivers a delicious and rejuvenating experience<br />
  with every glass.
</p>
