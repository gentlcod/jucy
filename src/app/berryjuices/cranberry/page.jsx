...
import { cranBerryJuiceImg } from '../../../../public/assets';
...
const Cranberry = () => {
  ...
  A crisp and tangy delight, this cranberry juice offers a<br />
  refreshing burst of tartness and natural flavor. Rich in antioxidants<br />
  and vitamin C, it provides a boost to your immune system and promotes<br />
  overall wellness. Each sip delivers a zesty and invigorating taste,<br />
  perfectly capturing the essence of freshly squeezed cranberries.<br />
  Carefully crafted to maintain the fruit's natural brightness, this juice ensures<br />
  a high-quality, wholesome beverage. Its bold and tangy profile<br />
  ...
  at room temperature, this cranberry juice delivers a delicious<br />
  and revitalizing experience with every glass.
</p>
