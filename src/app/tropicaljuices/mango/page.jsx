...
import { honeyDewJuiceImg, mangoJuiceImg, plumJuiceImg } from '../../../../public/assets';
      ...
      <div className="pt-[29px] lg:pb-1 pb-42 overflow-hidden lg:px-[120px] px-5"
        ...
        <div className='flex flex-col lg:flex-row items-center'>
          ...
          <div className='flex flex-col justify-center ml-0 lg:ml-[9rem]'>
            ...
            A tropical indulgence, this mango juice offers a<br />
            rich burst of sweet and fruity flavor. Packed with vitamins A<br />
            and C, it supports your immune system and promotes overall<br />
            wellness. Each sip delivers a luscious taste of freshly squeezed<br />
            mangoes, capturing their natural sweetness and creamy texture.<br />
            Carefully crafted to preserve the fruit's vibrant essence, this juice<br />
            ensures a high-quality, wholesome beverage. Its smooth and tropical<br />
            profile makes it an excellent choice for a revitalizing start to your day<br />
            or a refreshing treat at any time. Whether enjoyed chilled or at room<br />
            temperature, this mango juice delivers a delicious and rejuvenating<br />
