...
import { apricotJuiceImg, cantalopeJuiceImg, guavaJuiceImg, papayaJuiceImg, peachJuiceImg, pineappleJuiceImg } from '../../../../public/assets';
    ...
    <>
      ...
      <div className="pt-[29px] lg:pb-1 pb-42 overflow-hidden lg:px-[120px] px-5"
        ...
        <div className='flex flex-col lg:flex-row items-center'>
          ...
          <div className='flex flex-col justify-center ml-0 lg:ml-[7.3rem]'>
            <h3 className='mb-4 tracking-wide text-[#53422B] text-xl'>
              Description: 
            </h3>

            <p className='text-[#555555] tracking-wider text-sm'>
  A tropical delight, this pineapple juice offers a<br />
  refreshing burst of sweet and tangy flavor. Rich in vitamin C<br />
  and bromelain, it supports your immune system and promotes<br />
  overall wellness. Each sip delivers a vibrant taste of freshly<br />
  squeezed pineapples, perfectly capturing their natural sweetness<br />
  and tang. Carefully crafted to maintain the fruit's natural brightness,<br />
  this juice ensures a high-quality, wholesome beverage. Its lively<br />
  and tropical profile makes it an excellent choice for a revitalizing<br />
  start to your day or a refreshing treat at any time. Whether enjoyed<br />
  chilled or at room temperature, this pineapple juice delivers a<br />
  delicious and rejuvenating experience with every glass.
</p>
