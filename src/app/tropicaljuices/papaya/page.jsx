...
import { apricotJuiceImg, cantalopeJuiceImg, guavaJuiceImg, papayaJuiceImg, peachJuiceImg } from '../../../../public/assets';
...
const Papaya = () => {
  ...
  A smooth and exotic delight, this papaya juice offers a<br />
  gentle burst of sweet and tropical flavor. Rich in vitamins A<br />
  and C, it supports your immune system and promotes overall<br />
  wellness. Each sip delivers a taste of freshly squeezed papayas,<br />
  capturing their natural sweetness and soft, creamy texture.<br />
  Carefully crafted to maintain the fruit's vibrant essence, this juice<br />
  ensures a high-quality, wholesome beverage. Its smooth and exotic<br />
  ...
  temperature, this papaya juice delivers a delicious and rejuvenating<br />
